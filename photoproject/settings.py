...
# お使いのものを入力してください
DEFAULT_FROM_EMAIL = 'kmm2459365@stu.o-hara.ac.jp'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp-mail.outlook.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'kmm2459365@stu.o-hara.ac.jp'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'Satuki0430' # Gmailのアプリ用パスワードを入力
